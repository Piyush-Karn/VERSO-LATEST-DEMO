...
import { Calendar, Users, MapPin, Plane, Train, CheckCircle, ArrowRight, Sparkles, Home, Loader2 } from 'lucide-react'
          ...
          <div className="min-h-screen bg-black text-white">
            <div className="p-6 border-b border-gray-800">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-yellow-200/80 text-lg italic">Choose your neighborhood in {tripContext.destination}</p>
              </div>
            </div>
          ...
          <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 animate-fade-in">
            <div className="text-center max-w-md">
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Weaving together flights, stays, and bookings into a beautiful itinerary
              </p>
              <div className="space-y-3 text-sm text-gray-500">
                <p className="animate-fade-in" style={{ animationDelay: '0.5s' }}>✓ Finding best flight connections</p>
